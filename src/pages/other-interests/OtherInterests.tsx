...
import gameTheyAreBillions from "../../assets/other-interests/favorite-games/TheyAreBillions.jpg";
...
const GAME_CARDS = [
	...
	<GameCard src={gameTheyAreBillions} title={"They Are Billions"} key={"gane-card-2"}></GameCard>,
	<GameCard src={gameFuri} title={"Furi"} key={"game-card-3"}></GameCard>,
	<GameCard src={gameTerraria} title={"Terraria"} key={"game-card-4"}></GameCard>,
	<GameCard src={gamePayday2} title={"PAYDAY 2"} key={"game-card-5"}></GameCard>,
	<GameCard src={gameZombies} title={"Call Of Duty Zombies"} key={"game-card-6"}></GameCard>,
	<GameCard src={gameBloons} title={"Bloons TD 6"} key={"game-card-7"}></GameCard>,
];
